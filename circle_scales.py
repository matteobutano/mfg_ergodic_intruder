...
# Load data
m_large = mfg_ergodic.mfg('bottom_left_large')
m_small = mfg_ergodic.mfg('bottom_left_small')
...
small_d_c_s = Circle((0, 0),radius =  m_small.R + (m_small.c_s/m_small.gam),fill = False,color = 'black',label = r'$d_{c_s}$')
small_d_xi = Circle((0, 0),radius = m_small.R + m_small.xi,fill = False,color = 'white',label = r'$\xi$')
c_large = Circle((0, 0),radius = m_large.R)
large_d_c_s = Circle((0, 0),radius =  m_large.R + (m_large.c_s/m_large.gam),fill = False,color = 'black',label = r'$d_{c_s}$')
large_d_xi = Circle((0, 0),radius = m_large.R + m_large.xi,fill = False,color = 'white',label = r'$\xi$')
...
axs[0].add_patch(small_d_c_s)
axs[0].add_patch(small_d_xi)
...
axs[1].add_patch(large_d_c_s)
axs[1].add_patch(large_d_xi)
